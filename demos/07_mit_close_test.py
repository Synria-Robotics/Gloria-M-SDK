...
def main() -> int:
    ...
    ap.add_argument("--close-tau", type=float, default=-0.20, help="闭合方向扭矩，必须为负 [Nm]")
    ...
    ap.add_argument("--timeout", type=float, default=3.0, help="最长闭合测试时间 [s]")
    ...
    ap.add_argument("--save-dir", default="demos/output", help="采样结果输出目录")
