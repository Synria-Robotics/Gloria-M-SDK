...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--id", type=parse_int, default=MOTOR_ID, help="motor command CAN ID")
    ap.add_argument("--fb-id", type=parse_int, default=MOTOR_FB_ID, help="motor feedback CAN ID")
...
def main() -> int:
    ...
    return run_demo_with_monitor(
        args,
        demo_name="03_mit_linkage_force_control",
        title="Gloria-M MIT Current",
        thread_name="mit-control",
        run_demo=_run_demo,
    )
